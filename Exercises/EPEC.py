...
class EPEC:
    ...
    def iterate_cost_combinations(self):
        ...
        for run_id, init_cost_vector in enumerate(all_combinations):
            ...
            profits, alphas, dispatches, iterations, PoA, dispatch_ED, clearing_price_ED, final_dispatch, final_bid, clearing_price_SP, clearing_price_history = self.run_best_response(init_cost_vector, run_id)
    ...
    def run_best_response(self, init_cost_vector, run_id):
        ...
        while iter <= self.max_iter:
            ...
            if iter == self.max_iter:
                ...
                break
            iter += 1
        return profit_history, alpha_history, dispatch_history, iter, PoA, dispatch_ED, clearing_price_ED, final_dispatch, final_bid, clearing_price_SP, clearing_price_history
    ...
    def _build_objective(self, cost_vector):
...
if __name__ == "__main__":
    ...
    cost_min = [20, 30, 40, 50]
    cost_max = [60, 70, 80, 90]
